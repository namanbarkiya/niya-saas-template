...
import { ExternalLinkIcon, ArrowUpIcon } from "@radix-ui/react-icons";
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
                            Production-ready Next.js 15 template for developers
                            and AI startups. Built with modern best practices
                ...
                <div className="border-t pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                        &copy; {new Date().getFullYear()} Niya Template. Built
                        by{" "}
                        <a
